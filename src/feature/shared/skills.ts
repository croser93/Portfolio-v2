import { _React, AngularIcon, Postgresql, Css3, DjangoIcon, DockerIcon ,Figma, FirebaseIcon, GithubIcon, Javascript, N8nIcon, PostmanIcon, Python, Sass, SqliteIcon, SupabaseIcon, TailwindIcon, TypescriptIcon, GitIcon, ClaudeCode, VisualStudioCode } from "@dev.icons/react"
...
export const Tools: SkillItem[] = [
    ...
    { name: 'VS Code', Icon: VisualStudioCode, hoverColor: 'hover:bg-blue-500/20 hover:border-blue-500/40' },
    ...
    { name: 'ClaudeCode',  Icon: ClaudeCode, hoverColor: 'hover:bg-orange-500/20 hover:border-orange-500/40' },
