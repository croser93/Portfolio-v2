...
const Projects: ProjectItem[] = [
    ...
    { name: 'Coderr', img: '/assets/img/projects_img/Coderr.jpg', description: 'PORTFOLIO.4', language: ['Django', 'Python',], github: 'https://github.com/croser93/Coderr_BackEnd.git', live: 'https://coderr.maik-groth.com', category: 'Back End' , dialog_text: 'PORTFOLIO.4_DIALOG', imgpostion:"object-top-left" , live_test:true , coming_soon:false},
    { name: 'Quizly', img: '/assets/img/projects_img/quizly.jpg', description: 'PORTFOLIO.5', language: ['Django', 'Python',], github: 'https://github.com/croser93/Quizly_BackEnd.git', live: '', category: 'Back End' , dialog_text: 'PORTFOLIO.5_DIALOG', imgpostion:"object-center" , live_test:false , coming_soon:false},
    { name: 'Videoflix', img: '/assets/img/projects_img/videoflix.jpg', description: 'PORTFOLIO.6', language: ['Django', 'Python','Sqllite'], github: 'https://github.com/croser93/Videoflix_BackEnd.git', live: '', category: 'Back End' , dialog_text: 'PORTFOLIO.6_DIALOG', imgpostion:"object-center" , live_test:false , coming_soon:false},
