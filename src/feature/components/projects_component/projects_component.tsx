...
const Projects: ProjectItem[] = [
    ...
    { name: 'Videoflix', img: '/assets/img/projects_img/videoflix.jpg', description: 'PORTFOLIO.6', language: ['Django', 'Python',], github: 'https://github.com/croser93/Videoflix_BackEnd.git', live: '', category: 'PORTFOLIO.SOON' , dialog_text: 'PORTFOLIO.6_DIALOG', imgpostion:"object-center" , live_test:true , coming_soon:true},
