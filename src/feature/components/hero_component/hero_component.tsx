  ...
  return (
    <div className="relative dark:bg-[#0e0e0e] light:bg-[#ebe8e8]">
      ...
      <section id="home" className="hero flex items-center relative z-10">
        <div className="grid px-4 navbar:px-14 py-8 mx-auto gap-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-10 lg:justify-between content-beg">
          <div className="mx-auto navbar:mr-auto place-self-center lg:col-span-7 text-center navbar:text-left">
            ...
            <h1 className="font-Unbounded max-w-4xl mb-4 text-3xl font-extrabold tracking-tight leading-none navbar:text-4xl md:text-5xl xl:text-6xl dark:text-white">
            ...
            <div className='flex justify-center navbar:justify-start hover:no-underline'>
