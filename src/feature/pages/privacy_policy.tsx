    ...
    return (
        <section id="privacy-policy">
            <div className="content">
                ...
                <h2 className="privacy_title">{t( "PRIVACY.HEADLINE")}</h2>
                </div>
                ...
                <div className="privacy_section">
                    ...
                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_1.SUB_1")}</h4>
                    <p>{t( "PRIVACY.SECTION_1.P_1")}</p>
                    </div>

                    <div className="privacy_subsection_DataCollection">
                    <h4>{t( "PRIVACY.SECTION_1.SUB_2")}</h4>
                    
                    <div className="privacy_item">
                        <h5>{t( "PRIVACY.SECTION_1.Q_1")}</h5>
                        <p>{t( "PRIVACY.SECTION_1.A_1")}</p>
                    </div>

                    <div className="privacy_item">
                        <h5>{t( "PRIVACY.SECTION_1.Q_2")}</h5>
                        <p>{t( "PRIVACY.SECTION_1.A_2_1")}</p>
                        <p>{t( "PRIVACY.SECTION_1.A_2_2")}</p>
                    </div>

                    <div className="privacy_item">
                        <h5>{t( "PRIVACY.SECTION_1.Q_3")}</h5>
                        <p>{t( "PRIVACY.SECTION_1.A_3")}</p>
                    </div>

                    <div className="privacy_item">
                        <h5>{t( "PRIVACY.SECTION_1.Q_4")}</h5>
                ...
                <div className="privacy_section">
                    ...
                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_1")}</h4>
                    ...
                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_2")}</h4>
                    ...
                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_3")}</h4>
                    <p>{t( "PRIVACY.SECTION_3.P_8")}</p>
                    </div>

                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_4")}</h4>
                    <p>{t( "PRIVACY.SECTION_3.P_9")}</p>
                    </div>

                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_5")}</h4>
                    <p>{t( "PRIVACY.SECTION_3.P_10")}</p>
                    </div>

                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_6")}</h4>
                    <p>{t( "PRIVACY.SECTION_3.P_11")}</p>
                    </div>

                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_7")}</h4>
                    <p>{t( "PRIVACY.SECTION_3.P_12")}</p>
                    <p>{t( "PRIVACY.SECTION_3.P_13")}</p>
                    </div>

                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_8")}</h4>
                    <p>{t( "PRIVACY.SECTION_3.P_14")}</p>
                    </div>

                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_9")}</h4>
                    <p>{t( "PRIVACY.SECTION_3.P_15")}</p>
                    </div>

                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_10")}</h4>
                    <p>{t( "PRIVACY.SECTION_3.P_16")}</p>
                    </div>

                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_11")}</h4>
                    ...
                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_12")}</h4>
                    <p>{t( "PRIVACY.SECTION_3.P_19")}</p>
                    <p>{t( "PRIVACY.SECTION_3.P_20")}</p>
                    </div>

                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_3.SUB_13")}</h4>
                ...
                <div className="privacy_section">
                    ...
                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_4.SUB_1")}</h4>
                    ...
                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_4.SUB_2")}</h4>
                    ...
                    <div className="privacy_subsection">
                    <h4>{t( "PRIVACY.SECTION_4.SUB_3")}</h4>
